package com.jacx.ssoa.android.data;
...
import com.jacx.ssoa.android.common.AxelUtils;
...
import com.jacx.ssoa.android.data.xml.UnknownFileFormatException;
import com.jacx.ssoa.android.data.xml.XmlAttribute;
import com.jacx.ssoa.android.data.xml.XmlData;
import com.jacx.ssoa.android.data.xml.XmlNode;
import com.jacx.ssoa.android.parser.xml.XmlTreePullParser;
import com.jacx.ssoa.android.tasks.AsyncHtmlFileLoader;
import com.jacx.ssoa.android.tasks.AsyncXmlFileLoader;
import com.jacx.ssoa.android.tasks.AsyncXmlFileWriter;
import com.jacx.ssoa.android.tasks.AsyncXmlFileLoader.XmlFileLoaderListener;
import com.jacx.ssoa.android.tasks.AsyncXmlFileWriter.XmlFileWriterListener;
...
public class XmlEditor {
	...
	public XmlNode getmRoot() {
		return mRoot;
	}

	public void setmRoot(XmlNode mRoot) {
		this.mRoot = mRoot;
	}
	
	public void doLoadString(String content){
		
		XmlNode node = contentAsXml(content);
		if (node != null) {
			//parent = mSelection;
			if (mRoot.canHaveChild(node)) {
				node.setExpanded(true, true);
				node.updateChildViewCount(true);

				mRoot.addChildNode(node);
				mRoot.setExpanded(true);
				mRoot.updateParentViewCount();
