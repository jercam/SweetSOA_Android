...
public final class XmlNode extends TreeNode<XmlData> {
	...
	/**
	 * @see com.jacx.ssoa.android.data.tree.TreeNode#onParentChanged()
	 */
	@Override
	...
	/**
	 * @see com.jacx.ssoa.android.data.tree.TreeNode#onChildListChanged()
	 */
	@Override
	...
	/**
	 * @see com.jacx.ssoa.android.data.tree.TreeNode#toString()
	 */
	@Override
