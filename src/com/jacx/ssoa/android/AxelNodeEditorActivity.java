...
import com.jacx.ssoa.android.data.xml.XmlValidator;
import com.jacx.ssoa.android.ui.adapter.XmlAttributeAdapter;
...
public class AxelNodeEditorActivity extends Activity {
	...
	protected void onCreate(final Bundle savedInstanceState) {
		...
		mNode = ((SweetSOAApplication) getApplication()).getCurrentSelection();
	...
	protected void setDocumentDeclarationLayout() {
		...
		mCheckStandalone.setEnabled(((SweetSOAApplication) getApplication())
