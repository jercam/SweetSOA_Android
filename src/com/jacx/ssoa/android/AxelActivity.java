...
import com.jacx.ssoa.android.common.AxelChangeLog;
import com.jacx.ssoa.android.common.Constants;
import com.jacx.ssoa.android.common.RecentFiles;
import com.jacx.ssoa.android.common.Settings;
import com.jacx.ssoa.android.common.TemplateFiles;
import com.jacx.ssoa.android.data.XmlEditor;
import com.jacx.ssoa.android.data.XmlEditor.XmlEditorListener;
import com.jacx.ssoa.android.data.tree.TreeNode;
import com.jacx.ssoa.android.data.xml.XmlData;
import com.jacx.ssoa.android.data.xml.XmlHighlighter;
import com.jacx.ssoa.android.data.xml.XmlNode;
import com.jacx.ssoa.android.data.xml.XmlNodeStyler;
import com.jacx.ssoa.android.ui.adapter.TreeAdapter;
import com.jacx.ssoa.android.ui.adapter.TreeAdapter.TreeNodeEventListener;
import com.jacx.ssoa.android.ui.dialog.AttributeEditDialog;
...
public class AxelActivity extends Activity implements
	...
	private boolean sSOAResponse = false;
	/**
	 * 
	 */
	public AxelActivity() {
	...
	private void ssoaInit() {
		
		//ssoa load root
		Bundle extras = getIntent().getExtras();
		if (extras != null) {
			String xmlResponse = extras.getString(SSOAConstant.VAR_SOAP_RESPONSE_MESSAGE);		

			if(xmlResponse != null){
			
				setTitle(R.string.ui_response);
				
				mEditor.doLoadString(xmlResponse);
	...
	/**
	 * @see com.jacx.ssoa.android.ui.adapter.TreeAdapter.TreeNodeEventListener#onNodeLongPressed(com.jacx.ssoa.android.data.tree.TreeNode,
	...
	/**
	 * @see com.jacx.ssoa.android.ui.adapter.TreeAdapter.TreeNodeEventListener#onNodeTapped(com.jacx.ssoa.android.data.tree.TreeNode,
	 *      android.view.View, int)
	 */
	@Override
	...
	/**
	 * @see com.jacx.ssoa.android.ui.adapter.TreeAdapter.TreeNodeEventListener#onNodeDoubleTapped(com.jacx.ssoa.android.data.tree.TreeNode,
	 *      android.view.View, int)
	 */
	@Override
	...
	/**
	 * @see com.jacx.ssoa.android.data.XmlEditor.XmlEditorListener#onXmlDocumentChanged(com.jacx.ssoa.android.data.xml.XmlNode)
	 */
	@Override
	...
	/**
	 * @see com.jacx.ssoa.android.data.XmlEditor.XmlEditorListener#onXmlDocumentSaved()
	 */
	@Override
	...
	/**
	 * @see com.jacx.ssoa.android.data.XmlEditor.XmlEditorListener#onXmlContentChanged()
	 */
	@Override
	...
	/**
	 * @see com.jacx.ssoa.android.data.XmlEditor.XmlEditorListener#onXmlConfirmNotification(java.lang.String)
	 */
	@Override
	...
	/**
	 * @see com.jacx.ssoa.android.data.XmlEditor.XmlEditorListener#onXmlInfoNotification(String)
	 */
	@Override
	...
	/**
	 * @see com.jacx.ssoa.android.data.XmlEditor.XmlEditorListener#onXmlErrorNotification(java.lang.String)
	 */
	@Override
	 ...
	 */
	private SweetSOAApplication getAxelApplication() {
		if (mAxelApplication == null) {
			mAxelApplication = (SweetSOAApplication) getApplication();
		}
	...
	private SweetSOAApplication mAxelApplication;
	...
	//sweetsoa code segment
	private void sendRequest(){
		
		//Toast toast = Toast.makeText(getApplicationContext(), "Make Request", Toast.LENGTH_SHORT);	
		//toast.show();
		...
		if(mEditor.hasRoot()){
			...
			try{
				...
				mEditor.getmRoot().buildXmlString(builder);
							
				Intent i = new Intent(getApplicationContext(), SSOASendRequestActivity.class);
				i.putExtra(SSOAConstant.VAR_SOAP_REQUEST_MESSAGE,builder.toString());
				startActivity(i);
				
			}catch(Exception e){
				
				Crouton.makeText(this, R.string.ui_invalid_request, Style.ALERT).show();
			...
			Crouton.makeText(this, R.string.ui_empty_request, Style.ALERT).show();
		}
